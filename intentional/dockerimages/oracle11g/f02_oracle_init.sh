...
# expdp purchase_v1/oracle@xe directory=oracle_dump dumpfile=purchase_v1-2023-06-07.dmp SCHEMAS=purchase_v1
# expdp salespurchase_v1/oracle@xe directory=oracle_dump dumpfile=salespurchase_v1-2023-06-07.dmp SCHEMAS=salespurchase_v1
